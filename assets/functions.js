...
function MaintainCounters() {
    ...
    this.nextCounter = function (identifier) {
        self.current = identifier;
    }
    this.getCounter = function (identifier) {
        return self.counters[identifier];
    }
    this.getCurrentCounter = function () {
        return self.counters[self.current];
    }
    this.getCurrentIdentifier = function () {
        return self.current;
    }
...
function MaintainClickEvents(gridSize) {
    ...
    this.cellOnClick = function (clickEvent) {
        ...
        if (el.className == identifier) {
            return null;
        }
        if (!(counter.canIncrease())) {
            return null;
        }
