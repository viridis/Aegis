                ...
                <form action="items.php" method="post" class="form-horizontal">
                    <div class="modal-body">
                        <div class="form-group row">
                            <div class="col-md-2">
                                <input name="itemAmount" type="text" class="form-control" id="itemAmount"
                                       placeholder="#" value="1" autocomplete="off">
                            </div>
                            <div class="col-md-5">
                                <select data-placeholder="Pick an item..." class="chosen-select" id="itemName"
                                        name="itemName">
                                    <option value=""></option>
                                    <?php foreach ($itemlist as $item) { ?>
                                        <option
                                            value="<?php print($item->getId()); ?>"><?php print($item->getName()); ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="col-md-5">
                                <input name="itemValue" type="text" class="form-control" id="itemValue"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="submitEditItem" action="items.php" method="post">
                    <div class="modal-body">
                        <div class="form-group">
                            <input type="hidden" class="form-control" id="editItemID" name="editItemID"
                                   placeholder="Item ID">
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="glyphicon glyphicon-pencil hand"
                                      onclick="editItem(<?php print($item->getId()); ?>);" data-toggle="modal"
                                      data-target="#editItem"></span>
                            </td>
                        </tr>
                    <?php
                    }
